...
int main(int argc, char** argv)
{
    ...
    {
        for (int j = 0; j < sizeof(second_matrix) / sizeof(second_matrix[0]); j++)
        {
            // i is the row for the first matrix
            // j is the collumn for the second matrix
            ...
            // these numbers have to be the same for matrix mult to work
